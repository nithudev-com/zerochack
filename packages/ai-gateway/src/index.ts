...
export type AiRequest = { tenantId: string; userId: string; roles: string[]; requestId: string; idempotencyKey: string; prompt: string; untrustedContext?: string; purpose: 'GENERAL_CHAT' | 'SECURITY_CHAT' | 'FINDING_EXPLANATION' | 'ISOLATED_REPAIR'; tools?: AiFunctionTool[]; signal?: AbortSignal };
