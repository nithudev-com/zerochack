...
export default defineConfig({
  ...
  webServer: [
    { command: 'npm run dev -w @zerochack/api', url: `${apiUrl}/health/live`, env: { API_HOST: '127.0.0.1', API_PORT: '4000', CORS_ORIGINS: webOrigin, CARE_ENABLED: 'true' }, reuseExistingServer: !process.env.CI },
