...
export const ownerSections=['Overview','Users','Approvals','Tenants','Websites','Specialists','Tickets','Subscriptions','Packages','Pricing','Quotes','Revenue','Affiliates','Commissions','Payouts','Backups','Monitoring','Security','Notifications','Email Automation','AI Gateway','Integrations','System Health','Audit Logs','Settings'] as const;
...
const groups=[
  ...
  {label:'Platform',items:['Notifications','Email Automation','AI Gateway','Integrations','Audit Logs','Settings']},
] as const;
