...
const items = [['Overview','overview'],['General Live Help','support'],['Available Jobs','jobs'],['My Tickets','tickets'],['Active Sessions','sessions'],['Performance','performance'],['Notifications','notifications'],['Profile','profile']] as const;
